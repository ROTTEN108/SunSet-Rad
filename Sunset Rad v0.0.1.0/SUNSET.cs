...
namespace SETTINGSUN_RADIANCE
{
    public class SUNSET_RADIANCE : Mod,IMod, Modding.ILogger
    {
        ...
        public static void ModHooks_HeroUpdateHook()
        {
            ...
            if (Camera != null)
            {
                if(Camera.GetComponent<CameraControl>() == null)
                {
                    ...
                    //Camera.AddComponent<DreamVerOff>();
        ...
        public class SceneSwitchDetector : MonoBehaviour
        {
            ...
            void OnSceneLoaded(Scene scene, LoadSceneMode mode)
            {
                ...
                if (scene.name == "GG_Workshop")
                {
                    ...
                    STATUS = ST;
                    //ST.GetComponent<BossStatue>().isAlwaysUnlockedDream = true;
                    //ST.GetComponent<BossStatue>().isHidden = true;
                    SW.SetActive(true);
                    ...
                    Camera.GetComponent<Dreamcheck>().Check();
                    Camera.AddComponent<Dreamcheck2>();
                }
            }
        }
        ...
        private void BossStatueDreamToggle_OnTriggerEnter2D(On.BossStatueDreamToggle.orig_OnTriggerEnter2D orig, BossStatueDreamToggle self, Collider2D collision)
        {
